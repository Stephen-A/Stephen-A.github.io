  ...
  return (
    <section id='about' className='about'>
        ...
        <div className='container w-full h-screen text-[#2d2e32]'>
            <div className='about-content flex flex-col justify-center items-center w-full h-96'>
                <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8 text-left'>
                    ...
                    <div className='text-left pb-8'>
                        ...
                        <p className='text-aside text-[1.1rem]'>As a junior front-end developer enthusiastic about crafting seamless and visually appealing web solutions. 
